    ...
    return (
      <div className="container">
        ...
        <form className="col-12 mt-2 mb-4" onSubmit={this.addStock}> 
          <input onChange={this.handleFormChange} className="mx-2" type="text" name="name" value={form.name} placeholder ="Name" required />
          <input onChange={this.handleFormChange} className="mx-2" type="number" name="shares_owned" value={form.shares_owned} placeholder ="Shares Owned" />
          <input onChange={this.handleFormChange} className="mx-2" type="number" name="cost_per_share" value={form.cost_per_share} placeholder ="Cost per Share" />
          <input onChange={this.handleFormChange} className="mx-2" type="number" name="market_price" value={form.market_price} placeholder ="Market Price" />
